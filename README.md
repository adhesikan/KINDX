...
A minimal, asset-free landing page highlighting KINDX services. The project uses plain HTML, CSS, and JavaScript with inline SVG logos and no external images or binary files.
